				...
				<div class="card-body">
					...
					<div>
						...
						<?php if ($acordion->contenido_enlace) { ?>
							<div>
								<a href="<?php $acordion->contenido_enlace; ?>" <?php if ($acordion->contenido_enlace_abrir == 1) { ?> target="_blank" <?php } ?> class="btn btn-block btn-vermas"> <?php if ($acordion->contenido_vermas) { ?><?php echo $acordion->contenido_vermas; ?><?php } else { ?>See More<?php } ?></a>
							</div>
						<?php } ?>
					</div>
				</div>
